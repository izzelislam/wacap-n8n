...
export declare class WorkflowExecute {
    ...
    runPartialWorkflow2(workflow: Workflow, runData: IRunData, pinData: IPinData | undefined, dirtyNodeNames: string[] | undefined, destinationNodeName: string, agentRequest?: AiAgentRequest): PCancelable<IRun>;
